    ...
    ui(new Ui::MainWindow)
{
    ...
    int in, lin;
    for(in=1;in<6;in++)//desativa todas as checkbox das entradas
    {
...
QString MainWindow::verif_esp(QString comando)//ffmpeg para especificar pastas e nomes de arquivos deve-se utilizar "\ " ao invés de " "
{
//    qDebug() << comando;
    int caract;
    caract=0;
